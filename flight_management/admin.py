...
admin.add_view(MybaseView(model.IntermAirport,db.session,name="Sân bay trung gian"))
admin.add_view(MybaseView(model.Plane,db.session,name="Máy bay"))
admin.add_view(MybaseView(model.Seat,db.session,name="Ghế"))
admin.add_view(MybaseView(model.Ticket,db.session,name="Vé"))
admin.add_view(MybaseView(model.TicketPrice,db.session,name="Danh sách đơn giá"))
